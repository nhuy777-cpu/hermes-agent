...
export const zh = defineLocale({
  ...
  settings: {
    ...
    mcp: {
      ...
      addTitle: '添加自定义连接器',
      addDesc: '将 Hermes 连接到你的数据和工具。',
      addConfirm: '添加',
      addOptional: '可选',
      addNameHint: '显示在服务器列表中。',
      addAdvanced: '高级设置',
      addTransport: '传输方式',
      addTransportStdio: '本地进程 (stdio)',
      addTransportHttp: '远程 (HTTP)',
      addTransportSse: '远程 (SSE)',
      addCommand: '命令',
      addCommandHint: 'Hermes 启动该服务器时运行的可执行文件。',
      addArgs: '参数',
      addArgsHint: '每行一个参数。',
      addEnv: '环境变量',
      addEnvHint: '每行一个 KEY=value。',
      addUrl: '远程 MCP 服务器 URL',
      addUrlHint: '服务器接受 MCP 请求的 HTTPS 地址，例如 https://mcp.example.com/mcp。',
      addClientId: 'OAuth 客户端 ID',
      addClientSecret: 'OAuth 客户端密钥',
      addOauthHint: '两项都留空时，将在服务器要求登录时自动注册。',
      addHeaders: '请求头',
      addHeadersHint: '每行一个 Name: value。',
      addTrustNotice:
        '请只使用你信任的开发者提供的连接器。Nous 无法控制开发者提供哪些工具，也无法保证它们按预期工作或不会变更。'
    },
    model: {
      loading: '正在加载模型配置...',
