...
export const en: Translations = {
  ...
  settings: {
    ...
    mcp: {
      ...
      addDesc: 'Connect Hermes to your data and tools.',
      addConfirm: 'Add',
      addOptional: 'optional',
      addNameHint: 'Shown in the servers list.',
      addAdvanced: 'Advanced settings',
      addTransport: 'Transport',
      addTransportStdio: 'Local process (stdio)',
      addTransportHttp: 'Remote (HTTP)',
      addTransportSse: 'Remote (SSE)',
      addCommand: 'Command',
      addCommandHint: 'The executable Hermes runs to start this server.',
      addArgs: 'Arguments',
      addArgsHint: 'One argument per line.',
      addEnv: 'Environment variables',
      addEnvHint: 'One KEY=value per line.',
      addUrl: 'Remote MCP server URL',
      addUrlHint: 'The HTTPS address where the server accepts MCP requests, for example https://mcp.example.com/mcp.',
      addClientId: 'OAuth Client ID',
      addClientSecret: 'OAuth Client Secret',
      addOauthHint: 'Leave both blank to register automatically when the server asks you to sign in.',
      addHeaders: 'Headers',
      addHeadersHint: 'One Name: value per line.',
      addTrustNotice:
        'Only use connectors from developers you trust. Nous does not control which tools developers make available and cannot verify that they will work as intended or that they won’t change.'
    },
    model: {
  ...
  sidebar: {
    ...
    projects: {
      ...
      menuStrictOn: 'Confine to folder',
      menuStrictOff: 'Stop confining to folder',
      strictBadge: 'Confined: file tools stay inside this folder (terminal is not confined)',
      menuDelete: 'Delete',
  ...
  composer: {
    ...
    attachLabel: 'Attach',
    cowork: {
      modeLabel: 'Composer mode',
      chat: 'Chat',
      chatTip: 'Plain conversation — no folder scope',
      cowork: 'Cowork',
      coworkTip: 'Work inside a project or folder: pick one below, files it changes show in the Files pane',
      projectOrFolder: 'Project or folder',
      projectsLabel: 'Projects',
      noProjects: 'No projects yet — browse a folder to start one',
      browseFolder: 'Browse folder…',
      browseFailed: 'Could not open the folder picker',
      recording: 'Recording skill',
      clicks: n => `${n} click${n === 1 ? '' : 's'}`,
      truncated: 'event cap reached — recording is partial',
      stopAndCreate: 'Stop & create skill',
      discard: 'Discard',
      stopTitle: 'Create a skill from this recording',
      stopDescription:
        'Hermes reads the captured clicks and screenshots (keystrokes were never recorded) and writes a reusable SKILL.md. Review the prompt it puts in the composer, then send.',
      namePlaceholder: 'Skill name, e.g. export-monthly-report',
      createSkill: 'Create skill',
      saved: (clicks, shots) => `Recording saved: ${clicks} clicks, ${shots} frames. Prompt is in the composer.`,
      stopFailed: 'Could not stop the recording'
    },
    files: 'Files…',
    folder: 'Folder…',
    images: 'Images…',
  ...
  rightSidebar: {
    ...
    sessionResults: 'Changed this session',
    sessionResultsEmpty: 'No files created or changed this session yet',
    sessionResultsTruncated: 'Folder too large to scan fully — list is partial',
    refreshSessionResults: 'Refresh session results',
